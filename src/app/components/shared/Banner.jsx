...
const Banner = () => {
  return (
    <div className="bg-gradient-to-b from-blue-800 to-purple-900 h-screen">
      <div className="flex flex-col items-center w-8/12 mx-auto text-center h-screen justify-center">
        <h1 className="text-6xl text-white font-semibold">
          Hire .NET Developers: Affordable, Dedicated .NET Experts in 72 hours
        </h1>
        <h2 className="text-2xl py-10 text-slate-300 ">
        ...
        <button className="flex mt-8 flex-row items-center gap-2 btn bg-white text-dark border px-12 py-4 rounded-lg text-xl font-semibold">
